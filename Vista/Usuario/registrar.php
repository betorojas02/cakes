	...
	<noscript>
		<div class="container">
			<center class="animated pulse infinite">
				...
				<font color="red">
					<h5 class="red-text">
						<p>La página que estás viendo requiere para su funcionamiento el uso de JavaScript. Si lo has deshabilitado intencionadamente,
			...
			<div class="col s12 m12 l6 " id="signup ">
				<form name="signup" method="post" id="form-item" action="">
					...
					<div class="input-field col s6">
						...
						<input class="validate" type="text" name="nombre" id="nombre" required pattern="[A-Za-z]{1,15}" title="Digite solo Letras en el campo Nombre : Digite solo un Nombre">
						<label>Nombre</label>
					</div>
					<div class="input-field col s6">

						<input class="validate" type="text" name="apellido" id="apellido" required pattern="[A-Za-z]{1,15}" title="Digite solo Letras en el campo Apellido : Digite solo un Apellido">
					...
					<div class="input-field col s6 m6 l6">
						...
						<input class="validate" type="number" name="telefono" id="telefono" required title="Digite solo numeros en el campo Telefono : Digite solo un Telefono">
					</div>
					<div class="input-field col s6 m6 l6">
						<label>Cedula</label>
						<input class="validate" type="number" name="cedula" id="cedula" required title="Digite solo numeros en el campo Cedula : Digite solo un Cedula	">
					</div>
					<!-- fecha -->
					<div class="input-field col s6">
						<label>fecha</label>
						<input type="text" class="datepicker" id="fecha" required title="Hacer click para tener una fecha">
					</div>
					<!-- <div class="col s12">
				...
				<p class="col s12 m12 l12 center">
					<h6 class="center">¿Ya tienes una cuenta?
